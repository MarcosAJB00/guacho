...
plt.figure(figsize=(8,6))
plt.plot(r_sorted, phi_i[2, :], '--', color='blue', lw=1.5, label='phiHeIM initial')
plt.plot(r_sorted, phi_f[2, :], '-', color='blue', lw=2, label='phiHeIM final')
plt.xlabel("Radio (Rp)")
plt.ylabel("Profundidad óptica")
plt.xlim(0.95, r_sorted[-1])
plt.yscale("log")
...
plt.legend()
plt.tight_layout()
plt.savefig("./perfiles/phiHeIM.png", dpi=300)
plt.show()