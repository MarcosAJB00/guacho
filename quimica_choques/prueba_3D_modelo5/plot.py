...
# PERFIL 1D SHOCK
shock = np.loadtxt('final_model_5.dat',comments='#')
shock_T_v = np.loadtxt('model_5.dat',comments='#')

r_s = shock[:,0] # en cm
r_s = r_s/Rp + r_standoff # en Rp, le sumo el r_standoff para que no arranque en 0
...
phi_c   = np.deg2rad(77.0) # coordenda azimutal (0° apunta hacia x positivos)
...
print('Diametro del box en RP: ', 2.0*L)
