program shock_grid 
  ...
  integer, parameter :: T0_points = 3
  integer, parameter :: u0_points = 15
  ...
  n0_grid = (/ 5.0d6 /) ! cm^-3
  T0_grid = (/ 1000.0d0, 1500.0d0, 2000.0d0 /) ! K
  u0_grid = (/ 8.0d5, 9.0d5,10.0d5, 11.0d5, 12.0d5, & 
             13.0d5, 14.0d5, 15.0d5, 16.0d5, 17.0d5, &
             18.0d5, 19.0d5, 20.0d5, 21.0d5, 22.0d5 /) ! cm/s
