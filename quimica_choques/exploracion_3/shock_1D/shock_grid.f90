program shock_grid 
  ...
  integer, parameter :: T0_points = 8
  integer, parameter :: u0_points = 9
  ...
  n0_grid = (/ 1.0d6,5.0d6,1.0d7,5.0d7,1.0d8 /) ! cm^-3
  T0_grid = (/ 500.0d0,1000.0d0, 1500.0d0, 2000.0d0, 2500.0d0,3000.0d0,3500.0d0,4000.0d0 /) ! K
  u0_grid = (/ 8.0d5, 10.0d5, 12.0d5, 14.0d5, 16.0d5, &
             18.0d5, 20.0d5, 25.0d5, 30.0d5 /) ! cm/s
