...
f0 = FortranFile('helines/HE_tau_3pj0_002.bin', 'r')
tau0 = f0.read_reals(np.float64)
tau0 = tau0.reshape((nx, ny, nv), order='F')

f1 = FortranFile('helines/HE_tau_3pj1_002.bin', 'r')
tau1 = f1.read_reals(np.float64)
tau1 = tau1.reshape((nx, ny, nv), order='F')

f2 = FortranFile('helines/HE_tau_3pj2_002.bin', 'r')
...
np.savetxt(
    'lightcurve_triplet_sinchoque2.dat',
    np.c_[
        xplanet,
        lc_planet,
        lc0,
