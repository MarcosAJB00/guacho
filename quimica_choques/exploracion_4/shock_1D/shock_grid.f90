program shock_grid 
  ...
  integer, parameter :: n0_points = 11
  integer, parameter :: T0_points = 14
  integer, parameter :: u0_points = 14
  ...
  n0_grid = (/ 5.0d5, 1.0d6, 2.5d6,5.0d6, 7.5d6, 1.0d7, 2.5d7, 5.0d7, 7.5d7, 1.0d8, 5.0d8/) ! cm^-3
  T0_grid = (/ 500.0d0,1000.0d0, 1500.0d0, 2000.0d0, 2500.0d0,3000.0d0,3500.0d0,4000.0d0, &
              4500.0d0, 5000.0d0, 5500.0d0, 6000.0d0, 6500.0d0, 7000.0d0/) ! K
  u0_grid = (/ 2.5d5, 5.0d5,7.5d5, 10.0d5,12.5d5, 15.0d5, 17.5d5, 20.0d5, 25.0d5, &
             30.0d5, 35.0d5, 40.0d5, 45.0d5, 50.0d5 /) ! cm/s
