...
# ============================================================
data_stand_off = np.loadtxt('./ram_pressure_ATES/cond_ini_shock_ATES.dat')
r_stand_off  = data_stand_off[:, 0]   # [Rp]
rho_stand_off = data_stand_off[:, 1]  # [g/cm³]
...
# PERFIL SIN CHOQUE
# ============================================================
sin_choque = np.loadtxt('./sin_choque/output/perfiles_finales.dat')
r_wos    = sin_choque[:, 0]   # [Rp]
HeIM_wos = sin_choque[:, 4]   # [cm⁻³]

data_p = np.loadtxt('./sin_choque/inputs/Hydro_ioniz.txt', comments='#')
