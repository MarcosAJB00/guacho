...
nxmap=256 #1032
nymap=856 # ficticius size to include the star diameter 
nymap_real= 256
rorb = 0.0532*1.49e13
torb = 4.88*86400.
...
dx=2.0*5.09421794574017*Rp/float(nxmap) #  dx in cm ( 1AU = 1.49e13 cm)
...
for nout in range(0,81):
    ...
    theta_plan= (nout-40)*np.pi*0.125/180 #pasos de 0.25°, de -10° a 10°
    yplan= 0.#nymap/2
