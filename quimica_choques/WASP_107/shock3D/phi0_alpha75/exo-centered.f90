...
subroutine init_exo()
  ...
  !----------------STAR PARAMETERS ------------------
  star%mass      = 0.69*msun!1.119*msun
  star%radius    = 0.66*rsun!1.155*rsun
!  star%amdot     = 0.0 !1.3E-16*msun/yr    ! Stellar Mass Loss rate (g s^-1)
  ...
  star%WV        = 287.0e5                  ! Stellar wind velocity (cm/s)
  star%WD        = 2.175e-20                  ! Stellar wind density  (g cm^-3)
  star%bfield    = 0.0                      ! Stellar magnetic field (g)
  star%S0H       = 1.186e13                   ! soft_euv lyman weinn flux
  star%S0He1     = 8.496e12                   ! hard_euv (1/cm2/s)
  star%S0He3     = 5.798e14                   ! soft_euv **(mid-UV)**
  !----------------PLANET PARAMETERS------------------
  planet%mass    = 0.096*mjup
  planet%amdot   = 0.0                       ! Planetary Mass Loss rate (g/s)
  planet%rho     = 3.6e-15
  planet%radius  = 0.94*rjup!1.359*Rjup
...
!         endif
       ...
       if(global_k <= 1 .and. global_i >= nxtot) then
          set_cell = .true.
