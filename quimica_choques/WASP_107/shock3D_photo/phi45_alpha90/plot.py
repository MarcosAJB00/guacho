...
phi_c   = np.deg2rad(45.0) # coordenda azimutal (0° apunta hacia x positivos)

alpha   = np.deg2rad(90.0) #tamaño angular radio del parche del parche
