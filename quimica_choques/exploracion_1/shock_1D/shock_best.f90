...
subroutine run_model(y0i, n0i, u0i, T0i, model_number)
  ...
  write(filename,'(A,I0,A)') './output/best_model.dat'
  open(20, file=filename, status='replace', action='write')
  write(20,'(A)') '# x[cm]  rho[g/cm^3]   T[K]   n[cm^-3]   u[cm/s]   y   P[dyn/cm^2]   h[erg/g]   L[erg/g] '
  write(20,*) x, rho, T0i, n, u, y, P, h, L
