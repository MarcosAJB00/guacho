program shock_grid 
  ...
  integer, parameter :: y0_points = 3

  real(kind=8) :: n0_grid(n0_points), T0_grid(T0_points)
  real(kind=8) :: u0_grid(u0_points), y0_grid(y0_points)


  n0_grid = (/ 1.0d6, 100.0d6 /) ! cm^-3
  T0_grid = (/ 1500.0d0 /) ! K
  u0_grid = (/ 10.0d5, 20.0d5, 30.0d5, 40.0d5 /) ! cm/s
  y0_grid = (/ 0.9d0, 0.7d0, 0.5d0  /) ! fraccion de ionizacion inicial
